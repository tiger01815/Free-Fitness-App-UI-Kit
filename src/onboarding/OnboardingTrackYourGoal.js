...
const OnboardingTrackYourGoalScreen = ({navigation}) =>{
    const insets = useSafeAreaInsets()
    return(
        <View style={styles.container}>
            <View>
                <Image source={require('../../assets/image/onboarding1.png')} style={styles.imagestyle}/>
            </View>
            ...
            <TouchableOpacity style={styles.nextbuttonstyle} onPress={()=>navigation.navigate('OnboardingGetBurn')}>
                <Image style={styles.nextbuttonimage} source={require('../../assets/image/onboarding-button-1.png')}/>
            </TouchableOpacity>
            {/* <LinearGradient
...
export default OnboardingTrackYourGoalScreen;